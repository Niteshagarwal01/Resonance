  ...
  return (
    <div className="p-8 pb-32 max-w-4xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row items-center md:items-end gap-8 mb-16">
        <div className="w-40 h-40 bg-gray-100 rounded-full border-4 border-white shadow-xl flex items-center justify-center text-gray-400 relative overflow-hidden">
        ...
        <div className="flex-1 text-center md:text-left">
          ...
          <h1 className="text-5xl font-black text-[#1A1A1A] mb-2">Guest Listener</h1>
          <p className="text-gray-500 font-medium">Joined June 2026 • 12 Followers • 48 Following</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div 
          onClick={() => {
            // For now, simple fake logout since we wiped DB
            localStorage.clear();
            router.push("/login");
          }}
