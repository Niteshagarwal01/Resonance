  ...
  return (
    <div className="min-h-screen w-full flex overflow-hidden relative" style={{ background: "#FAFAF8", color: "#1A1A1A" }}>
      ...
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
        ...
        <div className="blob-green absolute" style={{ width: 800, height: 800, bottom: -100, right: -100, opacity: 0.4 }} />
        <div className="blob-purple absolute" style={{ width: 600, height: 600, top: "20%", right: "20%", opacity: 0.3 }} />
      ...
      <div className="hidden lg:flex w-1/2 flex-col justify-between p-12 lg:p-16 relative z-20">
        ...
        >
          ...
          {success ? (
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="text-center py-8">
              <Mail size={48} color="#22c55e" className="mx-auto mb-4" />
              <h3 className="text-2xl font-bold text-[#1A1A1A] mb-2">Check your email</h3>
              <p className="text-[#555] font-medium">We sent a verification link to {email}. Please click it to activate your account.</p>
            </motion.div>
          ) : (
            <>
              <button 
              ...
              <p className="text-center mt-8" style={{ color: "#777", fontSize: 14, fontWeight: 600 }}>
                Already have an account? <Link href="/login" className="text-[#1A1A1A] hover:underline" style={{ fontWeight: 800 }}>Log in</Link>
              </p>
            </>
          )}
        </motion.div>
