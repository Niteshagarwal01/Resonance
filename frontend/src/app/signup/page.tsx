    ...
    <div className="min-h-screen relative flex items-center justify-center overflow-hidden bg-[#0a0a0a]">
      ...
      >
        <div className="text-center mb-10">
          <h1 style={{ fontSize: "clamp(2rem, 5vw, 2.8rem)", fontWeight: 900, color: "white", letterSpacing: "-0.04em", margin: "0 0 10px 0" }}>Join Resonance.</h1>
          <p style={{ color: "rgba(255,255,255,0.5)", fontSize: 16, margin: 0, fontWeight: 500 }}>Create an account to start listening together.</p>
        </div>
        ...
        {success ? (
          <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="text-center py-8">
            ...
            <p className="text-white/60 font-medium">We sent a verification link to {email}. Please click it to activate your account.</p>
          </motion.div>
        ) : (
          <>
            <button 
            ...
            <p className="text-center mt-8" style={{ color: "rgba(255,255,255,0.5)", fontSize: 14, fontWeight: 500 }}>
              Already have an account? <Link href="/login" className="text-white hover:underline" style={{ fontWeight: 700 }}>Log in</Link>
            </p>
          </>
        )}
      </motion.div>
